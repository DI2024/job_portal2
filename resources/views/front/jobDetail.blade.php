    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == true) {
                            // localStorage.setItem('message', 'Job applied successfully.');
                            localStorage.setItem('messageType', 'success');
                        } else {
                            // localStorage.setItem('message', 'Failed to apply for the job.');
        ...
        function saveJob(id) {
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        // localStorage.setItem('message', 'Job saved successfully.');
                        localStorage.setItem('messageType', 'success');
                    } else {
                        // localStorage.setItem('message', 'You have already saved this job.');
                        localStorage.setItem('messageType', 'error');
                    }
                    window.location.href = "{{ url()->current() }}";
                }
